...
function aiTurn() {
	...
	// Sélectionnez une cellule vide au hasard
	var emptyCellsList = emptyCells(board);
	var randomIndex = Math.floor(Math.random() * emptyCellsList.length);
	var selectedCell = emptyCellsList[randomIndex];
	x = selectedCell[0];
	y = selectedCell[1];

	// Effectuer le mouvement AI dans la cellule sélectionnée
	if (setMove(x, y, COMP)) {
